...
Attendance Management is a Laravel 12 web app designed to streamline DTR document generation and management. Upload an attendance XLS file, and the system automatically generates personalized DOCX files for each employee, organized by department for easy browsing and downloading. Built for local or offline-friendly environments like XAMPP. Only designed to fit the template of isabangan's DTR attendance management. ---system requested by sir ERICK
